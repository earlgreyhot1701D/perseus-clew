...
const CARDS = [
  ...
  { num: '05 / 06', score: '15', nameLine1: 'Content in', nameLine2: 'HTML', desc: 'Whether content is in the initial HTML or waiting for JavaScript. Many agents do not execute JS. A page that needs JS is invisible to them.', weight: 'Weight · 15 pts' },
